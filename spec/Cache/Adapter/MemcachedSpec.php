...
class MemcachedSpec extends ObjectBehavior
{
    ...
    function it_should_throw_exception_while_trying_to_remove_empty_key()
    {
        $this->shouldThrow('\Exception')->duringRemoveItem('');
    }
    ...
    function it_should_be_able_to_invalidate_all_cache()
    {
        $result = $this->clear();
